...
## PASS
- Sponsor legal name exists (sponsor.legal_name)
...
- Cover Letter and 1571 use the same sponsor name (sponsor.legal_name)
...
- Cover Letter fact is supported by canonical data. (sponsor.legal_name)
...
- Cover Letter fact is supported by canonical data. (protocol.version)
...
## CONFLICT
- Conflicting values found for product.dosage_form; human review required. (product.dosage_form)
- Conflicting values found for product.route; human review required. (product.route)
